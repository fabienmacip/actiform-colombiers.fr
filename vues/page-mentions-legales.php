...
<?php
    ...
    $_CAPITAL = "1 000,00";
    $_RCS = "RCS B&eacute;ziers 953 759 586";
    ...
    <div>
        ...
        <a href="index.php" id="back-home-from-ml" rel="accueil" class="link-to-home">&lt;&lt;&lt; accueil</a>
          ...
          <h1>MENTIONS LÉGALES</h1>
              Ce site est la propriété de la société <?= $_RAISON_SOCIALE ?>, au capital de <?= $_CAPITAL ?> €, <?= $_RCS ?>, dont les coordonnées sont :<br>
              
              <ul>
              <li>Adresse du siège social  : <?= $_ADRESSE_SIEGE_SOCIAL ?></li>
              <li>Téléphone : <?= $_TELEPHONE ?></li>
              <li>Courrier électronique : <a href="mailto:<?=$_MAIL?>" class="link"><?= $_MAIL ?></a></li>
              <li>N° de TVA intracommunautaire : <?= $_TVA ?></li>
              </ul>
              Le Directeur de la publication du site est <?= $_DIRECTEUR_PUBLICATION ?>, en sa qualit&eacute; de <?= $_QUALITE_DIRECTEUR_PUBLICATION ?>. <br>
              
              Hébergeur : <a href="http://www.lws.fr/" target="_blank" rel="noopener" class="link">LWS </a>– 4, RUE GALVANI – 75838 PARIS CEDEX 17<br>
              
              La création graphique et le développement du site ont été réalisés par Fabien MACIP.<br>
              Webmaster : M. Fabien MACIP – fabien.macip@gmail.com<br>
        
              Responsable publication : <?= $_RAISON_SOCIALE ?>. Le responsable publication est une personne morale.<br>
              
              <h2>Le contenu du site</h2>
              La société <?= $_RAISON_SOCIALE ?> garantit les caractéristiques essentielles des produits. 
              La société <?= $_RAISON_SOCIALE ?> ne peut être tenue responsable de l’utilisation et de l’interprétation de 
              l’information contenue dans ce site.<br>
              
              La société <?= $_RAISON_SOCIALE ?> ne peut être tenue pour responsable d’éventuels virus qui pourraient 
              ...
              La société <?= $_RAISON_SOCIALE ?> se réserve le droit de modifier le contenu de ses offres commerciales à 
              ...
              Ce site est la propriété de <?= $_DIRECTEUR_PUBLICATION ?> qui est titulaire de tous les droits
              ...
              Sauf autorisation écrite préalable de <?= $_DIRECTEUR_PUBLICATION ?>, le site et les informations 
              ...
              Crédit photo : <?= $_DIRECTEUR_PUBLICATION ?>.<br>
              ...
              le tout adressé à : <?= $_RAISON_SOCIALE ?> - <?= $_ADRESSE_SIEGE_SOCIAL ?>.<br>
              ...
              Ces liens sont établis de bonne foi et la société <?= $_RAISON_SOCIALE ?> ne peut être tenue pour responsable 
              de modifications intervenues sur ces sites. Par conséquent, ces liens hypertextes ne sauraient, 
              en aucun cas, engager la responsabilité de la société <?= $_RAISON_SOCIALE ?> : seule la responsabilité des 
              éditeurs des sites référencés sur le site de la société <?= $_RAISON_SOCIALE ?> pourra être engagée.<br>
